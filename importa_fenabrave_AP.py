...
html = urlopen("http://www.fenabrave.org.br/pdf/informativo/automatico/dadosregionais_novo.asp?id=Amap%E1&cap=")
...
import io
with io.open('UF_AP.csv', "w", encoding="utf-8") as file:
