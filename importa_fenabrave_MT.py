...
html = urlopen("http://www.fenabrave.org.br/pdf/informativo/automatico/dadosregionais_novo.asp?id=Mato%20Grosso&cap=")
...
import io
with io.open('UF_MT.csv', "w", encoding="utf-8") as file:
