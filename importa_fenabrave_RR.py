...
html = urlopen("http://www.fenabrave.org.br/pdf/informativo/automatico/dadosregionais_novo.asp?id=Roraima&cap=")
...
import io
with io.open('UF_RR.csv', "w", encoding="utf-8") as file:
