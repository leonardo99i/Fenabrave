...
html = urlopen("http://www.fenabrave.org.br/pdf/informativo/automatico/dadosregionais_novo.asp?id=Pernambuco&cap=")
...
import io
with io.open('UF_PE.csv', "w", encoding="utf-8") as file:
