...
html = urlopen("http://www.fenabrave.org.br/pdf/informativo/automatico/dadosregionais_novo.asp?id=Santa%20Catarina&cap=")
...
import io
with io.open('UF_SC.csv', "w", encoding="utf-8") as file:
