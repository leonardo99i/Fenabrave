...
html = urlopen("http://www.fenabrave.org.br/pdf/informativo/automatico/dadosregionais_novo.asp?id=Maranhao&cap=")
...
import io
with io.open('UF_MA.csv', "w", encoding="utf-8") as file:
