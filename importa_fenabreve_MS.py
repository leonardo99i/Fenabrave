...
html = urlopen("http://www.fenabrave.org.br/pdf/informativo/automatico/dadosregionais_novo.asp?id=Mato%20Grosso%20do%20Sul&cap=")
...
import io
with io.open('UF_MS.csv', "w", encoding="utf-8") as file:
