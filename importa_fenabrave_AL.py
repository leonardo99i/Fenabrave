...
html = urlopen("http://www.fenabrave.org.br/pdf/informativo/automatico/dadosregionais_novo.asp?id=Alagoas&cap=")
...
import io
with io.open('UF_AL.csv', "w", encoding="utf-8") as file:
