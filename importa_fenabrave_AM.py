...
html = urlopen("http://www.fenabrave.org.br/pdf/informativo/automatico/dadosregionais_novo.asp?id=Amazonas&cap=")
...
import io
with io.open('UF_AM.csv', "w", encoding="utf-8") as file:
