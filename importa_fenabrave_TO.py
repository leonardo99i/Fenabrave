...
html = urlopen("http://www.fenabrave.org.br/pdf/informativo/automatico/dadosregionais_novo.asp?id=Tocantins&cap=")
...
import io
with io.open('UF_TO.csv', "w", encoding="utf-8") as file:
