...
html = urlopen("http://www.fenabrave.org.br/pdf/informativo/automatico/dadosregionais_novo.asp?id=Rio%20Grande%20do%20Sul&cap=")
...
import io
with io.open('UF_RS.csv', "w", encoding="utf-8") as file:
