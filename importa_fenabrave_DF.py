...
html = urlopen("http://www.fenabrave.org.br/pdf/informativo/automatico/dadosregionais_novo.asp?id=Distrito%20Federal&cap=")
...
import io
with io.open('UF_DF.csv', "w", encoding="utf-8") as file:
