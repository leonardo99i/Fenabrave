...
html = urlopen("http://www.fenabrave.org.br/pdf/informativo/automatico/dadosregionais_novo.asp?id=Minas%20Gerais&cap=")
...
import io
with io.open('UF_MG.csv', "w", encoding="utf-8") as file:
