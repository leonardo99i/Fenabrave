...
html = urlopen("http://www.fenabrave.org.br/pdf/informativo/automatico/dadosregionais_novo.asp?id=Paraiba&cap=")
...
import io
with io.open('UF_PB.csv', "w", encoding="utf-8") as file:
