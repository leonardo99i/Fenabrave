...
html = urlopen("http://www.fenabrave.org.br/pdf/informativo/automatico/dadosregionais_novo.asp?id=Sergipe&cap=")
...
import io
with io.open('UF_SE.csv', "w", encoding="utf-8") as file:
