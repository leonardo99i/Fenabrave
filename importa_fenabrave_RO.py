...
html = urlopen("http://www.fenabrave.org.br/pdf/informativo/automatico/dadosregionais_novo.asp?id=Rond%F4nia&cap=")
...
import io
with io.open('UF_RO.csv', "w", encoding="utf-8") as file:
