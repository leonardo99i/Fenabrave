...
html = urlopen("http://www.fenabrave.org.br/pdf/informativo/automatico/dadosregionais_novo.asp?id=Rio%20de%20Janeiro&cap=")
...
import io
with io.open('UF_RJ.csv', "w", encoding="utf-8") as file:
