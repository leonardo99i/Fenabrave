...
html = urlopen("http://www.fenabrave.org.br/pdf/informativo/automatico/dadosregionais_novo.asp?id=Parana&cap=")
...
import io
with io.open('UF_PR.csv', "w", encoding="utf-8") as file:
