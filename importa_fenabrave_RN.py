...
html = urlopen("http://www.fenabrave.org.br/pdf/informativo/automatico/dadosregionais_novo.asp?id=Rio%20Grande%20do%20Norte&cap=")
...
import io
with io.open('UF_RN.csv', "w", encoding="utf-8") as file:
